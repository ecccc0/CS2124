...
public:       
    ...
    void movesInWith(Person& newRoommate) {
        if (this == &newRoommate) {
            cout << "Error: A person cannot move in with themselves." << endl;
            return;
        }
...
int main() {
    ...
    // p = 0x7fffffffd5ec;
    // rec04.cpp:79:9: error: invalid conversion from ‘long int’ to ‘int*’ [-fpermissive]

    // p = 10000;
    // Lab/Lab4/rec04.cpp:83:9: error: invalid conversion from ‘int’ to ‘int*’ [-fpermissive]
    ...
    *q  = *p;      
    ...
    //  pI = &sal;  
    // *pI = 7623;    
    // pointer points to a constant int
    ...
    //  error: assignment of read-only location ‘* pcI’
    // *pcI = 7623;    
    // porinter is constant

    // error: uninitialized ‘const cpI’
    // int* const cpI;
    // error: redeclaration of ‘int* const cpI’
    // int* const cpI(&joe);
    // error: redeclaration of ‘int* const cpI’
    // int* const cpI(&sal);
    ...
    // error: uninitialized ‘const cpcI’ 
    // const int* const cpcI;
    // error: redeclaration of ‘const int* const cpcI’
    // const int* const cpcI(&joe);
    // rror: redeclaration of ‘const int* const cpcI’
    // const int* const cpcI(&sal);
    // error: assignment of read-only variable ‘cpcI’
    //  cpcI = &joe;  // *cpcI = 234;  
    //  error: assignment of read-only variable ‘cpcI’
    //  cpcI = &sal;  
    // *cpcI = 7623; 
